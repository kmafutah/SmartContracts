...
async function main() {
    ...
    console.log("🚀 Deploying ZiG Ecosystem to Polygon zkEVM (Fixed)...");
    ...
    // Deploy ReparationsDAO with fuel system - IMPORTANT: Use current deployer as owner
    ...
    const dao = await ReparationsDAO.deploy(
        deployer.address, // initialOwner - use current deployer
    ...
    console.log("✅ Deployer voting power set to 10000");
    ...
    console.log("✅ Created test proposal successfully");
    ...
    const fs = require('fs');
    fs.writeFileSync(
        'deployment-polygon-zkevm-fixed.json',
        JSON.stringify(deploymentInfo, null, 2)
    );
    console.log("\n💾 Deployment info saved to deployment-polygon-zkevm-fixed.json");
