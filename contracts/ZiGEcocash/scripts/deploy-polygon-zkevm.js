...
async function main() {
    console.log("🚀 Deploying ZiG Ecosystem to Polygon zkEVM...");
    ...
    //if (balance === 0n) {
    //     console.error("❌ Deployer has no ETH. Please ensure the account has sufficient funds.");
    //     return;
    // }
