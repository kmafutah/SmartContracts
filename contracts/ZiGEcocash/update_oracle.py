...
def get_current_onchain_price(asset, asset_type):
    if asset_type == "crypto":
        data = new_oracle_hub.functions.cryptoPrices(asset).call()
    elif asset_type == "metal":
        data = new_oracle_hub.functions.metalPrices(asset).call()
    elif asset_type == "forex":
        data = new_oracle_hub.functions.forexPrices(asset).call()
...
def main():
    ...
    logging.info("✅ All oracle updates completed for both oracles.")
